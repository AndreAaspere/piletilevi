<template>
  <div class="bg-white rounded-md p-5 mx-4 mt-2 sm:mt-10">
    ...
    <div>
      <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
        <div class="cursor-pointer" v-for="(event, index) in events" :key="index"
          v-show="view === 'md' ? true : index < 2">
          <div class="absolute bg-red-600 w-5 pl-1 text-sm mt-2 rounded-r-full text-white">{{ index + 1 }}</div>
